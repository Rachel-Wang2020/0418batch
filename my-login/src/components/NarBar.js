...
const NavBar = (props) => {
  return (
    ...
    <div className="navbar">
        <ul>
            <li><a className="Management">Management Chuwa</a></li>
            ...
            <button type='button' onClick={props.handleModalOpen} className="loginicon">Sign In</button>
            </li>
